...
class CPProfileHeaderCard extends StatelessWidget {
  /// Creates [CPProfileHeaderCard].
  const CPProfileHeaderCard({required this.session, super.key});
          ...
          children: <Widget>[
            ...
            Expanded(
              child: Column(
                ...
                children: <Widget>[
                  Text(session.fullName, style: CPAppTextStyles.h2),
                  Text(session.email, style: CPAppTextStyles.body),
                ],
              ),
            ),
          ],
