...
class GameDetailMetrics extends StatelessWidget {
  /// Creates [GameDetailMetrics].
  const GameDetailMetrics({
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        MetricRow(title: context.l10n.text('provider'), value: provider),
        SizedBox(height: 8.h),
        MetricRow(title: context.l10n.text('rtp'), value: rtp),
        SizedBox(height: 8.h),
        MetricRow(title: context.l10n.text('volatility'), value: volatility),
      ],
    );
  }
}
