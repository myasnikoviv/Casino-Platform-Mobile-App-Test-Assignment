...
class CPGameDetailMetrics extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        CPMetricRow(title: context.l10n.text('provider'), value: provider),
        SizedBox(height: 8.h),
        CPMetricRow(title: context.l10n.text('rtp'), value: rtp),
        SizedBox(height: 8.h),
        CPMetricRow(title: context.l10n.text('volatility'), value: volatility),
      ],
    );
  }
}
